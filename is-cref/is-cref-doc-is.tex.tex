...
\title{\texttt{is-cref} --- Íslensk beyging í krossvísunum\\
  \large v0.1}
...
\begin{abstract}
  Pakkinn \texttt{is-cref} bætir við íslenskri beygingu í krossvísunum
...
við setningafræðilegt samhengi. \texttt{is-cref} leysir þetta vandamál
...
\texttt{is-cref} krefst eftirfarandi pakka, sem hlaðast sjálfkrafa:
