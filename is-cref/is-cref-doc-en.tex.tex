...
\title{\texttt{is-cref} --- Icelandic declension for cleveref\\
  \large v0.1}
...
\begin{abstract}
  The \texttt{is-cref} package adds Icelandic grammatical declension to
...
sentence. \texttt{is-cref} solves this by storing declension tables for
...
\texttt{is-cref} automatically loads the following packages:
